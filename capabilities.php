          ...
          <div class="absolute inset-x-0 bottom-4 flex justify-center gap-2" id="cert-slider-dots">
            ...
            <?php endforeach; ?>
                ...
                .cert-slide-img.active {
                    box-shadow: 0 0 0 6px #fde047, 0 0 24px 6px #fde047;
                    animation: cert-glow 1.5s infinite alternate;
                }
                @keyframes cert-glow {
                    from { box-shadow: 0 0 0 6px #fde047, 0 0 12px 6px #fde047; }
                    to { box-shadow: 0 0 0 12px #fde047, 0 0 32px 12px #fde047; }
                }
                </style>
                <script>
(function() {
