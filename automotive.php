        ...
        <section class="py-16 bg-slate-50">
            <div class="max-w-7xl mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <h2 class="text-2xl font-bold text-slate-900 mb-2">Automotive Manufacturing Excellence</h2>
                        <p class="text-slate-700 mb-2">We manufacture & assemble Automotive fixtures. (BIW & Powertrain).</p>
                        <p class="text-slate-700 mb-2">Topgrip Industries brings decades of manufacturing expertise to the automotive sector. Our specialized focus on Body-in-White (BIW) and Powertrain fixtures ensures precision, quality, and reliability for automotive manufacturers.</p>
                        <p class="text-slate-700">Our state-of-the-art facilities are equipped with advanced machinery and operated by skilled professionals who understand the critical requirements of the automotive industry.</p>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-slate-900 mb-2">Our Automotive Capabilities</h3>
                        <ul class="divide-y divide-slate-200">
                            <li class="py-2"><span class="font-semibold">BIW Fixtures:</span> Precision fixtures for Body-in-White assembly</li>
                            <li class="py-2"><span class="font-semibold">Powertrain Fixtures:</span> Specialized fixtures for engine and transmission assembly</li>
                            <li class="py-2"><span class="font-semibold">Custom Solutions:</span> Tailored fixtures to meet specific manufacturing requirements</li>
                            <li class="py-2"><span class="font-semibold">Quality Assurance:</span> ISO 9001:2015 certified processes</li>
                            <li class="py-2"><span class="font-semibold">Assembly Services:</span> Complete assembly and testing capabilities</li>
                        </ul>
                    </div>
                </div>
            </div>
